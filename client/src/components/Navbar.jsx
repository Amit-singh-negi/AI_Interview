...
<div className='flex items-center gap-6 relative'>
    ...
    <div>
        ...
        {showUserPopup &&(
            <div className='absolute right-0 mt-3 w-48 bg-white shodaw-xl border border-gray-200 rounded-xl p-4 z-50'>
                <p className='text-md text-teal-500 font-medium mb-1'>{userData?.name}</p>
