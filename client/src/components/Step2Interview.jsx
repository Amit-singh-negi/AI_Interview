...
function Step2Interview({ interviewData, onFinish }) {
  ...
  const finishInterview = async () => {
    ...
    try {
      ...
      setFinishError(
        error.response?.data?.message ||
          "Failed to finish the interview. Please try again.",
      );
    } finally {
          ...
          {!feedback ? (
            ...
            >
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-teal-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1 disabled:opacity-60"
              >
                {isLastQuestion ? (
                  <>
