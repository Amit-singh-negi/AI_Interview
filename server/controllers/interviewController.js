...
Resume:${safeResume}`;
    ...
    Base the questions on the candidate's role, experience, projects, interview mode, skills, and resume details.
    `,
      },
      {
        role: "user",
...
export const getInterviewReport = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Failed to find current user's interview report: ${error}` });
  }
};